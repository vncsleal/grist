...
export interface JobStorage {
  ...
  listJobs(modality?: import("@quillby/core").GenerationModality): Promise<import("@quillby/core").GenerationJob[]>;
  updateJob(jobId: string, patch: Partial<import("@quillby/core").GenerationJob>): Promise<void>;
  getMonthlyJobCount?(modality: import("@quillby/core").GenerationModality): Promise<number>;
}
