...
export const ui = {
  en: {
    ...
    'install.macos-note':
      'Drag to Applications. Also available as <a href="https://github.com/vncsleal/quillby/releases/latest/download/quillby-macos.pkg">.pkg installer</a>.',
  ...
  'pt-br': {
    ...
    'install.macos-note':
      'Arraste para Applications. Também disponível como <a href="https://github.com/vncsleal/quillby/releases/latest/download/quillby-macos.pkg">instalador .pkg</a>.',
